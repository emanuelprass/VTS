...
namespace SceletonAPI.Application.UseCases.MasterData.Command.DriverCreateUpdate
{
    ...
    public class DriverCreateUpdateCommandValidator : AbstractValidator<DriverCreateUpdateCommand>
    {
        ...
        {
            RuleFor(driver => driver.Data.FullName).NotEmpty().When(driver => driver.Data.Id == null || driver.Data.Id == 0);
            RuleFor(driver => driver.Data.Phone).NotEmpty().When(driver => driver.Data.Id == null || driver.Data.Id == 0);
            RuleFor(driver => driver.Data.VendorId).NotEmpty().When(driver => driver.Data.Id == null || driver.Data.Id == 0);
